...
function aof_set_coupler_flux(name, flux_type, implementation, atm_tr_index,     &
  ...
  real(wp),    dimension(:), optional, intent(in) :: param !< An unused argument that would be used to
  ...
  real(wp),                  optional, intent(in) :: mol_wt !< An unused argument that would usually be
