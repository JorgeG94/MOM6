...
use MOM_datatypes, only : wp
    ...
    type :: marbl_single_diagnostic_type
        ...
        real(wp), allocatable, dimension(:)   :: field_2d  !< dummy field
        real(wp), allocatable, dimension(:,:) :: field_3d  !< dummy field
    ...
    type :: marbl_single_saved_state_type
        ...
        character(len=0) :: units  !< dummy units
        character(len=0) :: vertical_grid  !< dummy grid
        real(wp), allocatable :: field_2d(:)  !< dummy field
        real(wp), allocatable :: field_3d(:,:)  !< dummy field
    ...
    type, public :: marbl_forcing_fields_type
        ...
        real(wp), pointer :: field_0d(:)   => NULL()  !< dummy pointer
        real(wp), pointer :: field_1d(:,:) => NULL()  !< dummy pointer
    ...
    type, public :: marbl_domain_type
        ...
        real(wp), allocatable :: zt(:)  !< dummy depths
        real(wp), allocatable :: zw(:)  !< dummy depths
        real(wp), allocatable :: delta_z(:)  !< dummy thicknesses
    ...
    type, public :: marbl_single_output_type
        ...
        ! data structure.
        character(len=0) :: short_name  !< dummy name
        real(wp), allocatable, dimension(:)   :: forcing_field_0d  !< dummy forcing_field_0d
        real(wp), allocatable, dimension(:,:) :: forcing_field_1d  !< forcing_field_1d
